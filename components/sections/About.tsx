...
export function About() {
  ...
  return (
    <section id="about" className="py-20 px-4 bg-gray-900 dark:bg-black text-white">
      <div className="container mx-auto max-w-6xl">
        {/* IT BERRIES style section */}
        <div className="space-y-12">
          <div className="border-t border-b border-gray-700 dark:border-gray-800 py-6">
            <h2 className="text-4xl md:text-5xl font-bold tracking-wider text-center">
              {t({ en: 'ABOUT ME', fr: 'À PROPOS', de: 'ÜBER MICH', es: 'SOBRE MÍ', zh: '关于我' })}
            </h2>
          </div>

          <div className="max-w-4xl mx-auto">
            <p className="text-lg leading-relaxed text-gray-300 dark:text-gray-400 text-center md:text-left">
              {t(about)}
            </p>

            <div className="flex justify-center mt-12">
              <button className="group relative px-8 py-3 overflow-hidden border-2 border-white dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-300">
